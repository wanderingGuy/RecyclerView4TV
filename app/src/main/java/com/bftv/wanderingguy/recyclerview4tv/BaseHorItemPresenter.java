 ...
 */
public class BaseHorItemPresenter extends BaseItemPresenter {
    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_hor_layout, parent, false);
